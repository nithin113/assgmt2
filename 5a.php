...
if (mysqli_num_rows($qry)>0) {
	...
	$query = mysqli_query($con,"INSERT INTO `bank`(`acno`, `fname`, `lname`, `dob`, `gender`) VALUES ('".$_POST['acno']."','".$_POST['fname']."','".$_POST['lname']."','".$_POST['dob']."','".$_POST['gender']."')")or die(mysqli_error($con));
if ($query) {
	echo "data uploaded";
}else{
